                        ...
                        <div className="container px-4">
                            <div className="row gy-4">
                                ...
                                <div className="col-md-3 text-center text-md-start">
                                    ...
                                    <ul className="list-unstyled small">
                                        <li><Link className="text-light text-decoration-none" to="/sobre">Sobre a
                                            Plataforma</Link></li>
                                        <li><Link className="text-light text-decoration-none" to="/Politica_privacidade">Política de
                                            Privacidade</Link></li>
                                        <li><Link className="text-light text-decoration-none" to="/Termos_uso">Termos de Uso</Link>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div className="col-md-3 mb-3 text-center text-md-start">
                                    ...
                                    <p className="small mb-1"><strong>Email:</strong> denuncias@pnd.gov.ao</p>
                            ...
                            <div className="text-center small text-muted">
                                &copy; 2026 — República de Angola. Todos os direitos reservados. <br />
