              ...
              <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul className="navbar-nav d-flex flex-row flex-wrap align-items-center gap-3">
                  ...
                  <li className="nav-item dropdown">
                    ...
                    <ul className="dropdown-menu shadow-sm border-0 animate__animated animate__fadeIn">
                      <li>
                        <Link className="dropdown-item d-flex align-items-center" to="/educacao/registrar">
                          <FaBuilding className="me-2 text-danger" /> Registrar Denúncia
                        </Link>
                      </li>
                         <li>
                        <Link className="dropdown-item d-flex align-items-center" to="/educacao/minhas">
                          <FaListAlt className="me-2 text-success" /> Minhas Denúncias
                        </Link>
                      </li>
                    </ul>
      ...
      {!isLoginPage && (
        <footer className="bg-white py-4 border-top mt-auto">
          <div className="container text-center">
            <div className="mb-2 small text-muted">&copy; 2025 Governo da República - Plataforma Nacional de Denúncias. Todos os direitos reservados.
</div>
