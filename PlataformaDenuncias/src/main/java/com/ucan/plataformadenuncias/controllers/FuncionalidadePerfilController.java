...
public class FuncionalidadePerfilController {
    ...
    @GetMapping("/{id}")
    public Optional<FuncionalidadePerfil> getById(@PathVariable Long id) {
    ...
    /*@PutMapping("/{id}")
    public FuncionalidadePerfil update(@PathVariable Long id, @RequestBody FuncionalidadePerfil entity) {
